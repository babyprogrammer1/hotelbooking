          ...
          {bookings.map((booking) => (
            <div key={booking.id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
              ...
              <div className='flex flex-col md:flex-row'>
                <img src={booking.room.images[0]} alt={booking.hotel.name} className='md:w-44 rounded shadow object-cover'/>
              ...
              {/* Date & Timings */}
              <div className='flex flex-col md:items-center md:gap-12 gap-8 mt-3'>
                <div>
                  <p>Check-in:</p>
              ...
              <div className='flex flex-col items-start justify-center pt-3'>
                ...
                {!booking.isPaid && (
                  <button className='text-xs border border-gray-400 py-1.5 px-4 rounded-full mt-4 hover:bg-gray-50 transition-all cursor-pointer'>
                    Pay Now
                  </button>
                )}
              </div>
